...
const propertyDetails= ({propertyDetails:{ price, rentFrequency, rooms, title, baths, area, agency, isVerified, externalId ,type,purpose,furnishingStatus,amenities,photos,description}}) => (
